...
//        var path = navLink.getAttribute("href");
//        // SECOND, add active class
//        window.location.href = path;
//    });
//    console.log(clicked);
//        document.addEventListener('DOMContentLoaded', function () {
//            console.log("hello after reloading");
//            navLink.classList.add(localStorage.getItem("activeClass"));
//            navLink.getAttributeNode("classlist");
//        }, false);
//});
